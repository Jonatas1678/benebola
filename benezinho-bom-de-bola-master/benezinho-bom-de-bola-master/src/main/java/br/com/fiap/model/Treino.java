...
@Table(name = "TB_TREINO",
        uniqueConstraints = {
                @UniqueConstraint(name = "UK_NM_TREINO", columnNames = "NM_TREINO")
        }
)
public class Treino {
    ...
    @Column(name = "DC_TREINO")
    private String descricao;

    @ManyToOne(fetch = FetchType.EAGER, cascade = CascadeType.DETACH)
    @JoinColumn(name = "ID_PREPARADOR", referencedColumnName = "ID_PREPARADOR",
            foreignKey = @ForeignKey(name = "FK_TREINO_PREPARADOR", value = ConstraintMode.CONSTRAINT)
    )
    ...
    @JoinColumn(name = "ID_FUNDAMENTO", referencedColumnName = "ID_FUNDAMENTO",
            foreignKey = @ForeignKey(name = "FK_TREINO_FUNDAMENTO", value = ConstraintMode.CONSTRAINT)
    )
    private Fundamento fundamento;

    @ManyToOne(fetch = FetchType.EAGER, cascade = CascadeType.DETACH)
    @JoinColumn(name = "ID_ATLETA", referencedColumnName = "ID_ATLETA",
            foreignKey = @ForeignKey(name = "FK_TREINO_ATLETA", value = ConstraintMode.CONSTRAINT)
    )
